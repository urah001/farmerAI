      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    Make data-driven decisions for your farm with our AI-powered recommendations for crops, disease
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  ...
                  <Button variant="outline" size="lg" asChild>
                    <Link href="/disease-detection">Detect Plant Diseases</Link>
                  </Button>
                </div>
              </div>
              <Image
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our AI-driven platform provides comprehensive tools to enhance your farming practices
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="mt-4">Crop Recommendations</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
                    Get personalized crop suggestions based on your soil conditions, weather patterns, and historical
                    data using our Random Forest model.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <CardDescription className="text-base">
                    Upload images of your plants to identify diseases and get treatment recommendations using our CNN
                    model.
                  </CardDescription>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Current Weather</h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Stay updated with the latest weather conditions for your farm
                </p>
              </div>
            </div>
